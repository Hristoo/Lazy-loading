...
Plugin URI: https://github.com/Hristoo/Lazy-loading
Description: Lazy loading Images in WordPress.
Author: Hristo Dimitrov
Author URI: http://hristodimitrov.website
Text Domain: shll
Version: 1.0
...
function sh_add_lazyload_placeholders_callback($content) {
    ...
    foreach ($dom_obj->getElementsByTagName('img') as $node) {
        ...
        $default_load_img_src = 'http://dev-pashev.1dxr.com/wp148/wp-content/uploads/2018/07/builder-logo4.png';
